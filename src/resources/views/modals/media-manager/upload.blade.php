<div class="border-2 border-slate-200 border-dashed rounded-lg h-96 bg-slate-50 text-center p-6 flex flex-col justify-center items-center gap-2 dark:bg-slate-700 dark:border-slate-500">
