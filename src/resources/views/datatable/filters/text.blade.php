<div class="border border-2 border-slate-200 flex flex-col rounded overflow-hidden mb-3 dark:border-slate-600">
    ...
    <input type="text" wire:model.defer="filters.{{$key}}" class="relative border-0 group block w-full focus:ring-0 dark:bg-slate-400 dark:text-slate-100" id="{{ $uid }}" placeholder="..."/>
</div>
