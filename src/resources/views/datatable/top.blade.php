    ...
    <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        @if($isSearchable)
            <div class="relative rounded-md shadow-sm group block md:inline-block w-full md:w-auto mb-3 md:mb-0">
                <input wire:model.debounce.500ms="searchQuery" type="text" class="focus:ring-primary-500 focus:border-primary-500 block w-full pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="Search ...">
        ...
        <div class="flex items-center justify-end gap-2">
            ...
            <div
                ...
                class="relative">
                <button @click="isOpen = !isOpen" class="relative py-1.5 px-4 rounded-md flex justify-between items-center font-medium bg-white shadow-sm border border-gray-300 text-slate-400 w-full md:w-auto">
            ...
            <button
                ...
                class="relative py-1.5 px-4 rounded-md flex justify-between items-center font-medium bg-white shadow-sm border border-gray-300 text-slate-400 w-full md:w-auto">
...
@if($appliedFilters)
    <div class="{{ $appliedFilterStyle }}">
        ...
        @foreach($appliedFilters as $filterActive)
            <div class="inline-flex items-center bg-slate-100 py-2 px-3 text-slate-500 rounded">
                <strong class="font-normal text-slate-500">{{ $filterActive['title'] }}</strong>
